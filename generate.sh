...
MAKEFILE
    if (_ge(\$version, "5.17.1")) {
        _patch_gnumakefile(\$version, <<'PATCH');
$(diff -L win32/GNUmakefile -L win32/GNUmakefile -u v5.16.0/GNUmakefile v5.17.1/GNUmakefile)
PATCH
    }
    if (! -e 'README.uts') { # _ge(\$version, "5.17.3")
        _patch_gnumakefile(\$version, <<'PATCH');
$(diff -L win32/GNUmakefile -L win32/GNUmakefile -u v5.17.1/GNUmakefile v5.17.3/GNUmakefile)
PATCH
    }
...
MAKEFILE
    if (_ge(\$version, "5.10.1")) {
        _patch_gnumakefile(\$version, <<'PATCH');
$(diff -L win32/GNUmakefile -L win32/GNUmakefile -u v5.10.0/GNUmakefile v5.10.1/GNUmakefile)
PATCH
    }
    if (_ge(\$version, "5.11.0")) {
        _patch_gnumakefile(\$version, <<'PATCH');
$(diff -L win32/GNUmakefile -L win32/GNUmakefile -u v5.10.1/GNUmakefile v5.11.0/GNUmakefile)
PATCH
    }
    if (_ge(\$version, "5.11.3")) {
        _patch_gnumakefile(\$version, <<'PATCH');
$(diff -L win32/GNUmakefile -L win32/GNUmakefile -u v5.11.0/GNUmakefile v5.11.3/GNUmakefile)
PATCH
    }
}
...
MAKEFILE
    if (_ge(\$version, "5.9.1")) {
        _patch_gnumakefile(\$version, <<'PATCH');
$(diff -L win32/GNUmakefile -L win32/GNUmakefile -u v5.9.0/GNUmakefile v5.9.1/GNUmakefile)
PATCH
    }
    if (_ge(\$version, "5.9.2")) {
        _patch_gnumakefile(\$version, <<'PATCH');
$(diff -L win32/GNUmakefile -L win32/GNUmakefile -u v5.9.1/GNUmakefile v5.9.2/GNUmakefile)
PATCH
    }
    if (_ge(\$version, "5.9.3")) {
        _patch_gnumakefile(\$version, <<'PATCH');
$(diff -L win32/GNUmakefile -L win32/GNUmakefile -u v5.9.2/GNUmakefile v5.9.3/GNUmakefile)
PATCH
    }
    if (_ge(\$version, "5.9.4")) {
        _patch_gnumakefile(\$version, <<'PATCH');
$(diff -L win32/GNUmakefile -L win32/GNUmakefile -u v5.9.3/GNUmakefile v5.9.4/GNUmakefile)
PATCH
    }
...
MAKEFILE
    if (_ge(\$version, "5.8.1")) {
        _patch_gnumakefile(\$version, <<'PATCH');
$(diff -L win32/GNUmakefile -L win32/GNUmakefile -u v5.8.0/GNUmakefile v5.8.1/GNUmakefile)
PATCH
    }
...
PATCH
    ...
    if (_ge(\$version, "5.7.3")) {
        _patch_gnumakefile(\$version, <<'PATCH');
$(diff -L win32/GNUmakefile -L win32/GNUmakefile -u v5.7.2/GNUmakefile v5.7.3/GNUmakefile)
PATCH
    }
}
